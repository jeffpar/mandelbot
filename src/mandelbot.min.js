...
F.prototype.Z=function(a,c){var b=this;c=c?document.getElementById(c):null;switch(a){case F.CONTROL_STATUS:this.aa=c;M(this);break;case F.CONTROL_RESET:c&&(c.onclick=function(){b.N=[];U(b);b.J==b.X&&b.M==b.Y&&b.i==b.U&&b.v==b.V?T(b,G,H,N,O):T(b,b.X,b.Y,b.U,b.V)});break;case F.CONTROL_PREVIOUS:if(this.T=c)c.onclick=function(){var a=b.N.pop();if(null!=a){I(b,b.P,a);b.f=!!J(b,K,b.f);b.R=J(b,L,b.R);var a=J(b,P,b.ka,!1),c=J(b,Q,b.la,!1),f=J(b,R,b.ha,!0),h=J(b,S,b.ia,!0);T(b,a,c,f,h);U(b)}};U(this);break;
