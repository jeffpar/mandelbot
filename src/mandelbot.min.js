...
function F(a,c,b,d,e,f,h,g,k,l,q){a=void 0===a?0:a;c=void 0===c?0:c;b=void 0===b?G:b;d=void 0===d?H:d;e=void 0===e?I:e;f=void 0===f?J:f;K(this,l);this.f=!!L(this,M,h||!1);this.R=L(this,N,g||F.PALETTE.GRAY);this.ga=k||F.SHAPE.RECT;this.$=[0,0,0,0];this.N=[];try{this.Z(F.CONTROL_STATUS,q);var t;a:if(this.P=l,this.H=this.G=0,l){if(this.K=document.getElementById(l))if(this.H=this.K.width,this.G=this.K.height,this.F=this.K.getContext("2d")){this.F.imageSmoothingEnabled=!1;ca(this,this.K);t=!0;break a}O(this,
"Missing view canvas");t=!1}else t=!0;var p;if(p=t)a:{var m=a||this.H,D=c||this.G;if(this.B=document.createElement("canvas"))if(this.B.width=this.a=m||da,this.B.height=this.b=D||ea,this.D=this.B.getContext("2d"))if(this.l=this.D.createImageData(this.a,this.b)){p=!0;break a}O(this,"Unable to create grid canvas");p=!1}p&&(this.X=L(this,P,this.ka=b,!1),this.Y=L(this,Q,this.la=d,!1),this.U=L(this,R,this.ha=e,!0),this.V=L(this,S,this.ia=f,!0),T(this,this.X,this.Y,this.U,this.V,!1))}catch(ma){O(this,ma.message)}}
F.prototype.Z=function(a,c){var b=this;c=c?document.getElementById(c):null;switch(a){case F.CONTROL_STATUS:this.aa=c;O(this);break;case F.CONTROL_RESET:c&&(c.onclick=function(){b.N=[];U(b);b.I==b.X&&b.M==b.Y&&b.i==b.U&&b.v==b.V?T(b,G,H,I,J):T(b,b.X,b.Y,b.U,b.V)});break;case F.CONTROL_PREVIOUS:if(this.T=c)c.onclick=function(){var a=b.N.pop();if(null!=a){K(b,b.P,a);b.f=!!L(b,M,b.f);b.R=L(b,N,b.R);var a=L(b,P,b.ka,!1),c=L(b,Q,b.la,!1),f=L(b,R,b.ha,!0),h=L(b,S,b.ia,!0);T(b,a,c,f,h);U(b)}};U(this)}};
...
d*a.c+c,b=a.u-b*a.j-e),T(a,d,b,c,e,!0))):(a.f?(d=a.s.plus(a.c.times(a.g)),b=a.u.minus(a.j.times(a.m))):(d=a.s+a.g*a.c,b=a.u-a.m*a.j),T(a,d,b,a.i,a.v,!0)),a.h=a.A=-1,a.o=a.w=0),a.g=a.m=-1,a.W=0);0<=a.h&&(a.D.lineWidth=1,a.D.strokeStyle="#00FF00",a.D.strokeRect(a.h,a.A,a.o,a.w));a.F&&a.F.drawImage(a.B,0,0,a.a,a.b,0,0,a.H,a.G)}
function T(a,c,b,d,e,f){a.f?(a.I=new BigNumber(c),a.M=new BigNumber(b),a.i=new BigNumber(d),a.v=new BigNumber(e),a.s=a.I.minus(a.i),a.c=a.i.times(2).dividedBy(a.a).round(20),a.u=a.M.plus(a.v),a.j=a.v.times(2).dividedBy(a.b).round(20)):(a.I=c,a.M=b,a.i=d,a.v=e,a.s=c-d,a.c=2*d/a.a,a.u=b+e,a.j=2*e/a.b,console.log("prepGrid("+a.P+"): "+a.I+"-"+a.i+" "+a.a+" ("+a.s+"+"+a.c+")"));fa(a,0);a.ba=!0;for(c=0;c<a.b;c++)for(b=0;b<a.a;b++)ga(a,b,c,16777215,0);c=a.i;b=a.v;var h;"number"==typeof c?h=Math.min(c,b):
h=BigNumber.min(c,b);a.ea=Math.floor(223/Math.sqrt(.001+4*h));O(a,"X: "+a.I+", Y: "+a.M+", D: +/-"+a.i+", Max Iterations: "+a.ea+(a.f?" (BigNumbers)":""));!1!==f&&(a.P&&(f&&(a.N.push(location.hash),U(a)),f=ha+"="+a.P,f+="&"+P+"="+a.I,f+="&"+Q+"="+a.M,f+="&"+R+"="+a.i,f+="&"+S+"="+a.v,f+="&"+M+"="+a.f,f+="&"+N+"="+a.R,location.hash=f),Z(!0))}
function fa(a,c){a.L=c;if(a.ga){var b=Math.trunc(a.b/2),d=b-a.L,b=Math.round(Math.sqrt(b*b-d*d));a.C=Math.trunc(a.a/2)-b;a.fa=2*b}else a.C=0,a.fa=a.a;a.f?(a.J=a.s.plus(a.c.times(a.C)),a.S=c?a.S.minus(a.j):a.u.plus(0)):(a.J=a.s+a.c*a.C,a.S=c?a.S-a.j:a.u)}function K(a,c,b){b=void 0===b?location.hash:b;a.ca={};if(c){for(var d={},e,f=/([^#&=]+)=([^&]*)/g;e=f.exec(b);)d[e[1]]=e[2];d[ha]==c&&(a.ca=d)}}
function L(a,c,b,d){c=a.ca[c];if("boolean"==typeof b)return c&&("true"==c||+c)||!c&&b?1:0;b=c||b;a.f&&void 0!==d?(a=new BigNumber(b),d&&(a=a.abs())):(a=+b,d&&(a=Math.abs(a)));return a}function U(a){a.T&&(a.N.length?a.T.removeAttribute("disabled"):a.T.setAttribute("disabled","disabled"))}function O(a,c){c=c||a.da||"";a.aa?(a.aa.innerHTML=c,a.da=""):a.da=c}function ga(a,c,b,d,e){c=4*(c+b*a.a);a.l.data[c]=d&255;a.l.data[c+1]=d>>8&255;a.l.data[c+2]=d>>16&255;a.l.data[c+3]=void 0===e?255:e}
...
function Z(a){if(!a){z=0;for(var c=A.length;c--;){for(var b=A[B],d=!1,e=b.C,f=b.L,h=0,g=0,k=Math.floor((b.f?E:C)/A.length);b.L<b.b;){for(;0<k&&0<b.fa--;){var d=b.ea,l=ja(b.J,b.S,d,b.$),q=b,t=b.C++,p=b.$,m=0;if(p[1]){var D=!0,m=5+(p[0]-p[1])-na-Math.log(Math.log(p[2]+p[3]))*la;switch(b.R){default:m=-1;break;case F.PALETTE.GRAY:m=Math.floor(512*m/p[0]);255<m&&(m=255);m=m|m<<8|m<<16;break;case F.PALETTE.BRIGHT:m=ka(360*m/p[0],1);break;case F.PALETTE.MUTED:D=!1;case F.PALETTE.BLUE:m=ka(360*m/p[0],10*
m/p[0]),D&&(m=m&4278255360|m>>16&255|(m&255)<<16)}}ga(q,t,b.L,m);b.f?b.J=b.J.plus(b.c):b.J+=b.c;g||h++;k-=d-l;d=!0}if(0>=k)break;fa(b,b.L+1);g++;e=0;h=b.a}d&&(0<b.C&&g++,h=void 0===h?b.a:h,g=void 0===g?b.b:g,b.D.putImageData(b.l,0,0,void 0===e?0:e,void 0===f?0:f,h,g),b.F&&b.F.drawImage(b.B,0,0,b.a,b.b,0,0,b.H,b.G));d&&(a=!0);++B>=A.length&&(B=0)}}a&&!z&&(z=setTimeout(Z,0))}window.Mandelbot=F;F.prototype.addControl=F.prototype.Z;
