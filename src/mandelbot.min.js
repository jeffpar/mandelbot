mandelbot.js:483: WARNING - condition always evaluates to true
left : null
right: null
    if (fInit && idTimeout == null) {
                 ^^^^^^^^^^^^^^^^^

0 error(s), 1 warning(s), 90.4% typed
(function(){/*
 (c) Jeff Parsons 2017
 ...
 the above copyright.
*/
var p=null,q=1E3/60|0,r,t,u=[],v=0,w=1/Math.log(2),x=Math.log(.5)*w;
...
function K(l){if(!l){p=null;for(var m=u.length;m--;){for(var a=u[v],f=!1,d=a.f,g=a.l,e=0,c=0,h=r;a.l<a.j;){for(;0<h&&a.f<a.a;){var f=z(a.m,a.o,100,a.v),b=a.v,k=0;b[1]&&(k=5+(b[0]-b[1])-x-Math.log(Math.log(b[2]+b[3]))*w,k=Math.floor(512*k/b[0]),255<k&&(k=255),k=k|k<<8|k<<16);var b=a,n=4*(a.l*b.a+a.f);b.b.data[n]=k&255;b.b.data[n+1]=k>>8&255;b.b.data[n+2]=k>>16&255;b.b.data[n+3]=255;a.m+=a.F;a.f++;c||e++;h-=100-f;f=!0}if(0>=h)break;a.m=a.s;a.f=0;a.o-=a.H;a.l++;d=0;e=a.a;c++}f&&(c||c++,e=void 0===e?
a.a:e,c=void 0===c?a.j:c,a.C.putImageData(a.b,0,0,void 0===d?0:d,void 0===g?0:g,e,c),a.i.drawImage(a.c,0,0,a.a,a.j,0,0,a.A,a.w));f&&(l=!0);++v>=u.length&&(v=0)}}l&&null==p&&(p=setTimeout(K,0))}window.initViewport=function(l,m,a,f,d,g,e,c,h){h=void 0===h?!0:h;l=new y(l,m,a,f,d,g,e,c);h&&(u.push(l),r=Math.floor(t/u.length),K(!0));return l};})() //# sourceMappingURL=/src/mandelbot.js.map
