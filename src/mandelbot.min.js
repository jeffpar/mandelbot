...
l=!1}else l=!0;var m;if(m=l)a:{var r=a||this.I,X=c||this.H;if(this.C=document.createElement("canvas"))if(this.C.width=this.a=r||H,this.C.height=this.f=X||I,this.F=this.C.getContext("2d"))if(this.B=this.F.createImageData(this.a,this.f)){m=!0;break a}G(this,"Unable to create grid canvas");m=!1}m&&(this.W=D(this,J,this.ha=b),this.X=D(this,K,this.ia=d),this.S=D(this,L,this.ea=e,!0),this.T=D(this,M,this.fa=f,!0),N(this,this.W,this.X,this.S,this.T,!1))}catch(aa){G(this,aa.message)}}
x.prototype.$=function(a,c){var b=this;c=c?document.getElementById(c):null;switch(a){case x.CONTROL_STATUS:this.Y=c;G(this);break;case x.CONTROL_RESET:c&&(c.onclick=function(){b.N=[];O(b);b.J==b.W&&b.K==b.X&&b.c==b.S&&b.h==b.T?N(b,y,z,A,B):N(b,b.W,b.X,b.S,b.T)});break;case x.CONTROL_PREVIOUS:if(this.R=c)c.onclick=function(){var a=b.N.pop();if(null!=a){C(b,b.U,a);b.b=!!D(b,E,b.b);var a=D(b,J,b.ha),c=D(b,K,b.ia),f=D(b,L,b.ea,!0),h=D(b,M,b.fa,!0);N(b,a,c,f,h);O(b)}};O(this)}};
function F(a,c){a.O||(a.O=c,a.m=a.o=-1,a.V=0,a.g=a.v=-1,a.s=a.A=0,a.ga=!1,c.addEventListener("touchstart",function(b){P(a,Q,b)}),c.addEventListener("touchmove",function(b){P(a,R,b)}),c.addEventListener("touchend",function(b){P(a,S,b)}),c.addEventListener("mousedown",function(b){b.button||P(a,Q,b)}),c.addEventListener("mousemove",function(b){b.buttons&1&&P(a,R,b)}),c.addEventListener("mouseup",function(b){b.button||P(a,S,b)}),c.addEventListener("mouseout",function(b){P(a,S,b)}))}
function P(a,c,b){var d,e;if(c<S){b=b||window.event;b.targetTouches&&b.targetTouches.length?(d=b.targetTouches[0].pageX,e=b.targetTouches[0].pageY):(d=b.pageX,e=b.pageY);var f=0,h=0,g=a.O;do isNaN(g.offsetLeft)||(f+=g.offsetLeft,h+=g.offsetTop);while(g=g.offsetParent);d=a.I/a.O.offsetWidth*(d-f);e=a.H/a.O.offsetHeight*(e-h);d=Math.round(a.a*d/a.I);e=Math.round(a.f*e/a.H)}a.ga||b.preventDefault();0<=a.g&&a.F.putImageData(a.B,0,0);c==Q?(a.m=d,a.o=e,a.V=Date.now()):c==R?(c=Math.abs(a.o-e),10<=Math.abs(a.m-
d)&&10<=c&&(a.g=a.m,a.v=a.o,a.s=d-a.g,a.A=e-a.v,Math.abs(a.s/a.A)!=Math.abs(a.a/a.f)&&(c=Math.abs(a.a*a.A/a.f),a.s=0>a.s?-c:c))):c==S&&(200>Date.now()-a.V&&(a.s&&a.A?(d=a.g,b=a.v,c=a.g+a.s,e=a.v+a.A,c<d&&(d=c,c=a.g),e<b&&(b=e,e=a.v),a.m>d&&a.m<c&&a.o>b&&a.o<=e&&(a.b?(c=a.i.times(c-d).dividedBy(2),e=a.l.times(e-b).dividedBy(2),d=a.j.plus(a.i.times(d)).plus(c),b=a.w.minus(a.l.times(b)).minus(e)):(c=(c-d)*a.i/2,e=(e-b)*a.l/2,d=a.j+d*a.i+c,b=a.w-b*a.l-e),N(a,d,b,c,e,!0))):(a.b?(d=a.j.plus(a.i.times(a.m)),
b=a.w.minus(a.l.times(a.o))):(d=a.j+a.m*a.i,b=a.w-a.o*a.l),N(a,d,b,a.c,a.h,!0)),a.g=a.v=-1,a.s=a.A=0),a.m=a.o=-1,a.V=0);0<=a.g&&(a.F.lineWidth=1,a.F.strokeStyle="#00FF00",a.F.strokeRect(a.g,a.v,a.s,a.A));a.G&&a.G.drawImage(a.C,0,0,a.a,a.f,0,0,a.I,a.H)}
function N(a,c,b,d,e,f){a.b?(a.J=new BigNumber(c),a.K=new BigNumber(b),a.c=new BigNumber(d),a.h=new BigNumber(e),a.j=a.J.minus(a.c),a.i=a.c.times(2).dividedBy(a.a).round(20),a.w=a.K.plus(a.h),a.l=a.h.times(2).dividedBy(a.f).round(20),a.u=a.j.plus(0),a.L=a.w.plus(0)):(a.J=c,a.K=b,a.c=d,a.h=e,a.j=a.J-a.c,a.i=2*a.c/a.a,a.w=a.K+a.h,a.l=2*a.h/a.f,a.u=a.j,a.L=a.w);a.D=a.P=0;c=a.c;b=a.h;var h;"number"==typeof c?h=Math.min(c,b):h=BigNumber.min(c,b);a.ca=Math.floor(223/Math.sqrt(.001+4*h));G(a,"X: "+a.J+", Y: "+
a.K+", D: +/-"+a.c+", Max Iterations: "+a.ca+(a.b?" (BigNumbers)":""));!1!==f&&(a.U&&(f&&(a.N.push(location.hash),O(a)),f=T+"="+a.U,f+="&"+J+"="+a.J,f+="&"+K+"="+a.K,f+="&"+L+"="+a.c,f+="&"+M+"="+a.h,f+="&"+E+"="+a.b,location.hash=f),U(!0))}function C(a,c,b){b=void 0===b?location.hash:b;a.aa={};if(c){for(var d={},e,f=/([^#&=]+)=([^&]*)/g;e=f.exec(b);)d[e[1]]=e[2];d[T]==c&&(a.aa=d)}}
function D(a,c,b,d){c=a.aa[c];if("boolean"==typeof b)return c&&("true"==c||+c)||!c&&b?1:0;b=c||b;a.b?(a=new BigNumber(b),d&&(a=a.abs())):(a=+b,d&&(a=Math.abs(a)));return a}function O(a){a.R&&(a.N.length?a.R.removeAttribute("disabled"):a.R.setAttribute("disabled","disabled"))}function G(a,c){if(c=c||a.ba||"")a.Y?(a.Y.innerHTML=c,a.ba=""):a.ba=c}
