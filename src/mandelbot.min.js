...
function U(){w=!1;x=null;A=0;for(var b=!1,f=B.length;f--;){var a;a:{a=B[C];for(var c=!1;a.m<a.j;){for(;a.h<a.c;){J(a.l,a.o,0,a.v);var c=a.v,d=0;c[1]&&(d=5+(c[0]-c[1])-E-Math.log(Math.log(c[2]+c[3]))*D,d=Math.floor(512*d/c[0]),255<d&&(d=255),d=d|d<<8|d<<16);var c=a,e=4*(a.m*c.c+a.h);c.a.data[e]=d&255;c.a.data[e+1]=d>>8&255;c.a.data[e+2]=d>>16&255;c.a.data[e+3]=255;a.l+=a.F;a.h++;if(w){G(a);a=!0;break a}c=!0}a.l=a.s;a.h=0;a.o-=a.H;a.m++}c&&G(a);a=c}if(a){b=!0;break}++C>=B.length&&(C=0)}b&&(x=setTimeout(U,
0))}window.initViewport=function(b,f,a,c,d,e,l,g,h){h=void 0===h?!0:h;b=new F(b,f,a,c,d,e,l,g);h&&(B.push(b),null==x&&U());return b};})() //# sourceMappingURL=/src/mandelbot.js.map
